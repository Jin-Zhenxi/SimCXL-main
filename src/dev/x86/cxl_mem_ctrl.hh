...
class CXLMemCtrl : public PciDevice 
{
    protected:
        ...
        */
        ...
        /** MatrixFlow PNM accelerator (optional). */
        MatrixFlowEngine *matrixEngine;

        /** MMIO offset within CXL BAR for GEMM trigger (Host writes size here). */
        static constexpr Addr GEMM_TRIGGER_OFFSET = 0x10000;
